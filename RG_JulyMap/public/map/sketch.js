...
function setup(){
  //- - - - - overall
	...
	hench = [
		...
		{n: '0', c: startCol, r: 'Moon Gate', x: width/ 1.39, y: height/ 1.21},
		{n: '0', c: startCol, r: 'Mole Megavator', x: width/ 1.39, y: height/ 1.41},
